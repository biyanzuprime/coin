...
pkgdatadir = $(datadir)/biyanzuprime
pkgincludedir = $(includedir)/biyanzuprime
pkglibdir = $(libdir)/biyanzuprime
pkglibexecdir = $(libexecdir)/biyanzuprime
...
ACLOCAL = ${SHELL} /tmp/BiYanZuPrime/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/BiYanZuPrime/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/BiYanZuPrime/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/BiYanZuPrime/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = biyanzuprime-cli
BITCOIN_DAEMON_NAME = biyanzuprimed
BITCOIN_GUI_NAME = biyanzuprime-qt
BITCOIN_TX_NAME = biyanzuprime-tx
...
COPYRIGHT_HOLDERS_FINAL = The BiYanZuPrime Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = BiYanZuPrime Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/BiYanZuPrime/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = biyanzuprime
PACKAGE_BUGREPORT = https://github.com/biyanzuprime-project/biyanzuprime/issues
PACKAGE_NAME = BiYanZuPrime Core
PACKAGE_STRING = BiYanZuPrime Core 1.0.0
PACKAGE_TARNAME = biyanzuprime
PACKAGE_URL = https://biyanzuprime.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/BiYanZuPrime
abs_srcdir = /tmp/BiYanZuPrime
abs_top_builddir = /tmp/BiYanZuPrime
abs_top_srcdir = /tmp/BiYanZuPrime
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/BiYanZuPrime/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/BiYanZuPrime-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/BiYanZuPrime-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BiYanZuPrime-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BiYanZuPrime-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
