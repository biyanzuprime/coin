BiYanZuPrime Core version 0.13.3 is now available from:

  <https://download.biyanzuprime.org/biyanzuprime-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/biyanzuprime-project/biyanzuprime/blob/0.13/src/chainparams.cpp#L214).
