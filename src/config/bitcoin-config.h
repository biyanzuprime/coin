...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BiYanZuPrime Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BiYanZuPrime Core"
...
#define PACKAGE_BUGREPORT "https://github.com/biyanzuprime-project/biyanzuprime/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BiYanZuPrime Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BiYanZuPrime Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "biyanzuprime"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://biyanzuprime.org/"
