...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s biyanzuprime-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  biyanzuprime-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded biyanzuprime transaction") + "\n" +
              "  biyanzuprime-tx [options] -create [commands]   " + _("Create hex-encoded biyanzuprime transaction") + "\n" +
              "\n";
